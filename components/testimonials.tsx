...
const testimonials = [
  {
    content: "As a user, I want to see information about the GT Movies Store so I can learn more about the app and its purpose.",
    categories: [1],
  },
  {
    content:
  ...
  {
    content:
      "As an administrator, I want to be able to manage (view, create, update, or delete) reviews from the GT Movies Store so we can keep information up to date.",
    categories: [2],
  },
  {
    content:
      "As an administrator, I want to be able to manage (view, create, update, or delete) orders from the GT Movies Store so we can keep information up to date.",
    categories: [3],
  },
];
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
            ...
            <p className="text-lg text-indigo-200/65">
              User Stories Implemented by the Developers
            </p>
        </div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              ...
              >
                ...
                <span>Geetacharan Koyaguri</span>
              </button>
              {/* Button #4 */}
              <button
              ...
              >
                ...
                <span>Sri Ritvik Maddireddy</span>
              </button>
              {/* Button #5 */}
              <button
              ...
              >
                ...
                <span>Surya Abhinav Nookarapu</span>
              </button>
            </div>
          </div>
